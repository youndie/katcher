...
class CrashTrustTest {
    private val realStacktrace =
        ...
        kotlin.NoSuchElementException: Collection is empty.
        	...
        	at io.github.youndie.katcher.feature.schedule.data.ScheduleRepositoryImpl.reschedule(ScheduleRepositoryImpl.kt:121)
        	at io.github.youndie.katcher.feature.schedule.domain.RescheduleLessonSlotUseCase.invoke(RescheduleLessonSlotUseCase.kt:12)
