...
import io.github.youndie.katcher.feature.error.ProcessReportUseCase.Companion.generateFingerprint
...
class FingerprintTest {
    ...
    fun `native frames group by symbol`() {
        fun trace(address: String) =
            ...
            |	at 0   katcher   $address   kfun:io.github.youndie.katcher.auth#verify(kotlin.String){}
            |	at 1   katcher   $address   kfun:io.github.youndie.katcher.auth#route(){}
            """.trimMargin()
